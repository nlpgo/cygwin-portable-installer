...
set CYGWIN_PACKAGES=bash-completion,bzip,coreutils,curl,dos2unix,expect,git,grep,gawk,inetutils,openssh,openssl,perl,python3, recode,rsync,screen,sed,unzip,vim,zip
...
set MINTTY_OPTIONS=--Title Terminal ^
  ...
  -o ForegroundColour=0,0,0 ^
  -o BackgroundColour=255,255,255 ^
  -o CursorType=Block ^
  -o CopyOnSelect=yes ^
